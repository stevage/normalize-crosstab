...
Copy everything below into a Google Sheets Script.
...
function onOpen() {
  ...
  var items = [
    {name: 'Normalize Crosstab', functionName: 'showSidebar'},
  ];
...
function showSidebar() {
  var html = HtmlService.createHtmlOutput(
    ...
    '<p><button id="normalizeBtn" class="create" style="display:none;" onClick="google.script.run.withSuccessHandler(allDone).normalizeCrosstab();">Normalize</button></p>' + 
